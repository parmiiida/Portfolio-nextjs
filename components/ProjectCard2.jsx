  ...
  <section className="lg:mx-32 relative z-10">
    <div className={`${styles.innerWidth} flex mx-auto gap-5 lg:leading-[150px] md:leading-[60px] sm:leading-[74.4px] leading-[74.4px]`}>
      <div className="flex gap-4">
        <span className="lg:text-[30px] font-bold sm:text-[17px] text-[23px] mx-auto text-[#8892b0] sm:h-[20]">03.</span>
        ...
        >
          ...
          >
            ...
            <Image
              ...
              width={500}
              height={350}
              className="object-cover ml-28 border-none rounded-[6px] z-1"
            />
          </motion.div>
          <motion.div
